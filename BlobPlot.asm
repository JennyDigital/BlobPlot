...
BLOB_Plot				; Entry point for plotting.
  ...
  PHA					; Save our X coord for later.
  LDA BLOB_Y_U8
  STA BLOB_CurrBlob_Y_U8
  
  LDA BLOB_Mode_U8			; Pre-offsetting X co-ordinate according to option.
  BIT #BLOB_ModeXRev_Cb
  BEQ BLOB_X_Good_B
  
  CLC
  LDA #7
  ADC BLOB_CurrBlob_X_U8
  STA BLOB_CurrBlob_X_U8
  STA BLOB_X_U8
  
BLOB_X_Good_B  

  LDA BLOB_Mode_U8			; Pre-offsetting Y co-ordinate according to option.
  BIT #BLOB_ModeYRev_Cb
  BEQ BLOB_Y_Good_B
  
  CLC
  LDA #7
  ADC BLOB_CurrBlob_Y_U8
  STA BLOB_CurrBlob_Y_U8
...
BLOB_DoANSI_B
  ...
  JSR ANSI_write_vec			; Write our plot/unplot command.
...
BLOB_NoAction_B
  ...
  PLA					; Restore our X coordinate for later.
  STA BLOB_X_U8
